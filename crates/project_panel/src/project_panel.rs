...
use ui::{
    ...
    IndentGuideColors, IndentGuideLayout, Label, ListItem, Scrollbar, ScrollbarState,
    Tooltip,
};
...
impl ProjectPanel {
    ...
    fn notify_checkout(&self, cx: &mut ViewContext<Self>, checkout: bool) {
        let message = if checkout {
            String::from("The directory has been loaded")
        } else {
            String::from("The directory has been commited")
        };
        let _ = cx.prompt(
            PromptLevel::Info,
            "Checkout Status",
